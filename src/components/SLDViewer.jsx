...
export const SLDViewer = ({ siteId, site, embedded = false }) => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      toast.error('Failed to load SLD data');
      console.error(error);
    } finally {
      setLoading(false);
    }
    ...
    <div className={embedded ? "" : "space-y-4"}>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold">Single Line Diagram</h3>
          {site && <span className="text-sm text-muted-foreground">- {site.site_name}</span>}
        </div>
            ...
            <CardContent className="p-0">
              {sldData?.image_url ? (
                <div 
                  ...
                  style={{ height: embedded ? '500px' : 'calc(100vh - 320px)', minHeight: '400px' }}
                >
                ...
                <div 
                  ...
                  style={{ height: embedded ? '400px' : 'calc(100vh - 320px)', minHeight: '400px' }}
                >
            ...
            <Card>
              ...
              <CardContent className="p-0">
                <div className="max-h-[150px] overflow-y-auto">
                  {unmappedAssets.slice(0, 20).map((asset) => (
                    <div
                      key={asset.asset_id}
                  ...
                  {unmappedAssets.length > 20 && (
                    <p className="text-xs text-muted-foreground text-center py-2">
                      +{unmappedAssets.length - 20} more assets
                    </p>
                  )}
                </div>
              </CardContent>
